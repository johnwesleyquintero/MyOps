...
export const SummaryCards: React.FC<SummaryCardsProps> = ({ metrics }) => {
  ...
  return (
    <div className="mb-6">
      ...
      {/* Completion Rate Bar */}
      <div className="bg-white border border-slate-200 rounded-full px-4 py-2 shadow-sm flex items-center gap-4">
        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap">Completion Rate</span>
        ...
        <span className="text-xs font-mono font-bold text-slate-700 w-8 text-right">{completionRate}%</span>
      </div>
    </div>
  );
};