...
import { DEFAULT_PROJECTS, RECURRENCE_OPTIONS, TEMPLATE_STORAGE_KEY } from '../constants';
...
export const useTaskForm = (initialData: TaskEntry | null | undefined, entries: TaskEntry[]) => {
  // Form State
