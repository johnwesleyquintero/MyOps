    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-8 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3">
         ...
         <button 
            ...
            className="hidden sm:flex items-center gap-2 bg-slate-900 text-white px-3 py-2 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-slate-800 shadow-md hover:shadow-lg active:scale-95 transition-all"
         >
         ...
         <button 
            onClick={onOpenCreate}
            className="sm:hidden flex items-center justify-center w-8 h-8 bg-slate-900 text-white rounded-lg shadow-md hover:bg-slate-800"
         >
