...
export const AutomationView: React.FC<AutomationViewProps> = React.memo(
  ({ automations, isLoading, onSave, onDelete, onToggle }) => {
    const {
      isModalOpen,
      setIsModalOpen,
      editingAutomation,
            ...
            >
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div
                      className={`text-3xl font-black mb-1 ${aiColors.text}`}
                    >
            ...
            <div className="bg-notion-light-bg dark:bg-notion-dark-bg border border-notion-light-border dark:border-notion-dark-border rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    log: "Lead to Task triggered for 'John Doe'",
                    time: "14:23",
                  },
                  {
                    log: "Artifact Reward awarded to 'Operator'",
                    time: "09:15",
                  },
                ].map((item, i) => (
                  <div
